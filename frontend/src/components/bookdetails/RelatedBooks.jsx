  ...
  return (
     <div className='flex flex-col gap-10  p-2 md:p-5'>
        <div className='flex items-center justify-between'>
            <h1 className="md:text-3xl font-bold">You may also like</h1>
        ...
        <div  className='overflow-hidden border-none p-3 flex flex-col md:flex-row md:flex-wrap gap-5 lg:gap-15
